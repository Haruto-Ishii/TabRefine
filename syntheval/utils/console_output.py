...
# def print_results_to_text(utility_output_txt,privacy_output_txt,fairness_output_txt,output_folder):
#     output_file = f"{output_folder}/eval_syntheval.txt"
...
# """
#             )
#             f.write(utility_output_txt.rstrip())
#             f.write("""\n+---------------------------------------------------------------+\n""")
...
# """
#                 )
#             f.write(privacy_output_txt.rstrip())
#             f.write("""\n+---------------------------------------------------------------+\n""")
#         if fairness_output_txt != '':
#             f.write("""\
# Fairness metric description                   value   error                                 
...
# """
#                 )
#             f.write(fairness_output_txt.rstrip())
#             f.write("""\n+---------------------------------------------------------------+\n""")
